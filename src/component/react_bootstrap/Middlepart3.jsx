    ...
    <Container>
      <Row>
        <Col xs={6} md={4}>
          ...
          <p className="text_formation" >Quicker than your cravings! Enjoy super-speed service and receive fresh, delicious food in no time.</p>

        </Col>
        <Col xs={6} md={4}>
          <Image src={myimage4} rounded style={{ width: '200px', height: '200px' }}/>
          <h5>Live Order Tracking</h5>
          <p className="text_formation">Track your order in real-time as it makes its way from the restaurant to your doorstep.</p>

        </Col>
        <Col xs={6} md={4}>
          <Image src={myimage5} rounded style={{ width: '200px', height: '200px' }} />
          <h5>Your Favorite Restaurants</h5>
          <p className="text_formation">Explore top-rated restaurants near your chosen location and enjoy your favorite meals anytime.</p>
        </Col>
      </Row>
    </Container>
  );
